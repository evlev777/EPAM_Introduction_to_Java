...
public class Programm{
    ...
    public static void main(String[] args) throws IOException {
        ...
        TaxiStation station = new TaxiStation("D:\\IDEA\\IntelliJ IDEA Community Edition 2018.2.4\\TaxiStation\\src\\OOP\\ListCar.txt");

        List<Car> carPool = station.getCarPool();


        //посчситать стоимость автопарка
        double poolPrice = 0.0;
        for(Car car : carPool){
            poolPrice += car.getPriece();
        }
